    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Continue growing your forest</p>
        </div>
        ...
        <div className="flex gap-3">
          <motion.button whileHover={{ scale: 1.03 }} className="flex-1 py-2.5 rounded-xl glass text-sm font-medium flex items-center justify-center gap-2">
